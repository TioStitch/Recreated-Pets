...
implements IPetData {
    ...
    public String getURL() {
        ...
        final FileConfiguration fC = main.getConfig();

        final String camp = fC.getString("mysql-configuration.");

        connection.append("jdbc:mysql://").append(camp + "database").append(camp + "host" + "/");
        connection.append(camp + "hostname").append("?autoReconnect=true&useUnicode=yes");
